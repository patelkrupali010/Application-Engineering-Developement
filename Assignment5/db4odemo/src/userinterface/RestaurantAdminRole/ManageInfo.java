...
public class ManageInfo extends javax.swing.JPanel {
    ...
    public ManageInfo(JPanel userProcessContainer, UserAccount account, EcoSystem ecosystem) {
        ...
        txtPwd.setText(restaurant.getPassword());
        ...
        if(flag == 1){
                for(UserAccount userAccount: ecosystem.getUserAccountDirectory().getUserAccountList()){
                    if(txtUsername.getText().equals(userAccount.getUsername())){
                        if(userAccount.getRestaurantId()!= restaurant.getRestaurantId())
                        {
            ...
            restaurant.setPassword(txtPwd.getText());
            
            JOptionPane.showMessageDialog(this,"Restaurant Info are updated.");
    ...
    private void txtAddressKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAddressKeyPressed
        ...
        if(Character.isDigit(c) || Character.isWhitespace(c) || Character.isISOControl(c)){
            ...
            JOptionPane.showMessageDialog(txtAddress, "Invalid entry. Please enter digits only.");
        }
